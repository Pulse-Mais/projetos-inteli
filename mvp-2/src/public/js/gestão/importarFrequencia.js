/* ============================================================
   importarFrequencia.js — Importar Frequência via CSV
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ── Fechar / Cancelar ── */
  document.getElementById('btnClose').addEventListener('click', () => history.back());
  ...
  btnImportar.addEventListener('click', async () => {
    ...
    try {
      ...
      let msg = `${resultado.importados} registro(s) de frequência importado(s) com sucesso.`;
